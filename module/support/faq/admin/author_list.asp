...
'--------------------------------------------------------------------
' author_list.asp
'	Displays a list of the current FAQ articles for the site
'
...
<H3><% steTxt "FAQ Author List" %></H3>

<P>
<% steTxt "Shown below are all of the FAQ authors defined in the database." %>
</P>
...
<TR CLASS="list<%= I mod 2 %>">
	...
	<TD>
		...
		<A HREF="author_delete.asp?authorid=<%= rsAuthor.Fields("AuthorID").Value %>" class="actionlink"><% steTxt "delete" %></A>
	</TD>
</TR>
<%	rsAuthor.MoveNext
	I = I + 1
...
<P ALIGN="center">
	<a href="FAQ_list.asp" class="adminlink"><% steTxt "FAQ List" %></a> &nbsp;
	<A HREF="author_add.asp" class="adminlink"><% steTxt "Add New FAQ Author" %></A>
</P>
