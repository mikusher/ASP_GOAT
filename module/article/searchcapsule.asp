...
<%= Replace(Application("ModCapHeader"), "<CAPSULETITLE/>", "Article Search") %>
<%= Application("ModCapLeft") %>
<form method="post" action="<%= Application("ASPNukeBasePath") %>news/search.asp">
...
<tr>
	...
	<td align="right"><input type="submit" name="_submit" value=" Find Articles " class="form"></td>
</tr>
</table>
