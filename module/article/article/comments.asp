...
Sub locComment(aComment)
	...
	For I = 0 To UBound(aComment, 2)
		...
		oMesg.Item("M" & aComment(0, I)) = "<table border=0 cellpadding=2 cellspacing=0 width=""100%"">" & vbCrLf &_
			...
			"<div align=""right""><a href=""comment_post.asp?articleid=" & nArticleID & "&replyid=" & aComment(0, I) & "&subject=" & Server.URLEncode("re: " & aComment(2, I)) & """ class=""commentlink"">" & steGetText("Reply") & "</A></div>" & vbCrLf &_
