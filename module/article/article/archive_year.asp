...
'--------------------------------------------------------------------
' article_year.asp
'	Display a list of archived articles for the specified year.
'
...
Else
	sErrorMsg = steGetText("The article publication year must be specified")
End If
%>
