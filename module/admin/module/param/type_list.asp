...
'--------------------------------------------------------------------
' type_list.asp
'	Displays a list of the current param types defined in the database
'
...
Select Case sAction
	Case "moveup"
		...
		If Not rsPrev.EOF Then
			...
			sStat = "UPDATE	tblModuleParamType " &_
...
<H3><% steTxt "Module Param Type List" %></H3>

<P>
<% steTxt "The following module param types are defined in the database." %>&nbsp;
<% steTxt "These control the main areas of your content layout." %>&nbsp;
<% steTxt "You cannot just create a new param type and have it show up on the site," %>&nbsp;
<% steTxt "special ASP script must be written to handle new types." %>
</P>
...
<P><B CLASS="error"><% steTxt "Sorry, No types exist in the database" %></B></P>
