...
'--------------------------------------------------------------------
' type_add.asp
'	Add a new module type to the database
'
...
If steForm("action") = "add" Then
	...
	Else
		...
		sStat = "SELECT Coalesce(Max(OrderNo) + 1, 1) As OrderNo FROM tblModuleParamType"
		...
		sStat = "INSERT INTO tblModuleParamType (" &_
				...
				steQForm("QuoteChar") & "," & adoGetDate &_
				")"
...
<H3><% steTxt "Add New Module Type" %></H3>

<P>
<% steTxt "Please enter the properties for the new module type using the form below." %>&nbsp;
...
<H3><% steTxt "New Parameter Type Added" %></H3>

<P>
<% steTxt "The new module parameter type has been added to the database." %>&nbsp;
